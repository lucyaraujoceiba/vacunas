...
public class Usuario {
    ...
    public Usuario(Long id,String nombre, String clave,LocalDateTime fechaCreacion, String numeroIdentificacion, String tipoIdentificacion, String fechaNacimiento) {
